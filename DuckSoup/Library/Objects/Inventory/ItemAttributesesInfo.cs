...
public class ItemAttributesesInfo : IItemAttributesInfo
{
    ...
    public ItemAttributesesInfo(ulong value)
    {
        Variance = value;
    }
    ...
    public bool Equals(IItemAttributesInfo other) => Variance == other.Variance;

    public override bool Equals(object obj) => obj is ItemAttributesesInfo variance && Equals(variance);

    public bool Equals(ItemAttributesesInfo other) => Variance == other.Variance;
    ...
    /// <returns></returns>
    public IEnumerable<byte> CompareSlots(ItemAttributesesInfo info)
    {
    ...
    public static explicit operator ItemAttributesesInfo(ulong value) => new(value);

    public static implicit operator ulong(ItemAttributesesInfo variance) => variance.Variance;

    public static bool operator ==(ItemAttributesesInfo left, ItemAttributesesInfo right) => left.Equals(right);

    public static bool operator !=(ItemAttributesesInfo left, ItemAttributesesInfo right) => !(left == right);
