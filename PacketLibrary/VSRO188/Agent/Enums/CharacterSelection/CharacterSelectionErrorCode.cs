namespace PacketLibrary.VSRO188.Agent.Enums.CharacterSelection;
...
public enum CharacterSelectionErrorCode : ushort
{
    ...
    /// <summary>
    ///     This user is already connected. The user may still be connected because of an error that forced the game to close.
