...
public class SERVER_AGENT_PARTY_MATCHING_FORM_RESPONSE : IPacketStructure
{
    public static ushort MsgId => 0xB069;
    ...
    {
        return new SERVER_AGENT_PARTY_MATCHING_FORM_RESPONSE
        {
            Result = 1,
