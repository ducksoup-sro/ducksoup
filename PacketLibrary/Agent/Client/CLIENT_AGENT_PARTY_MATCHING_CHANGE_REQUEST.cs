...
public class CLIENT_AGENT_PARTY_MATCHING_CHANGE_REQUEST : IPacketStructure
{
    public static ushort MsgId => 0x706A;
    ...
    {
        return new CLIENT_AGENT_PARTY_MATCHING_CHANGE_REQUEST()
        {
